...
const buttonStyles: IButtonStyles = {
    default:
        'inline-flex items-center gap-3 justify-center text-base whitespace-nowrap rounded-md font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blaze-500 disabled:pointer-events-none disabled:opacity-50 duration-300 transition',
    variant: {
        ...
        outline: 'border border-coral-600 bg-transparent shadow-sm hover:bg-coral-600 text-coral-600 hover:text-white',
